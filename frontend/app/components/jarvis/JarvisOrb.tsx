...
import { ORB_STATE_LABELS, type OrbState } from "./jarvisTypes";
...
export function JarvisOrb({ state, getLevel, active, onActivate, onDeactivate, hosting, connecting }: Props) {
  ...
  useEffect(() => {
    ...
    raf = requestAnimationFrame(pump);
    return () => { cancelAnimationFrame(raf); renderer.stop(); rendererRef.current = null; };
  ...
  return (
    <div className="relative flex flex-col items-center">
      <div className="relative h-[300px] w-[380px] xl:h-[360px] xl:w-[460px]">
            ...
            >
              ...
              >
                <span className="mono text-[13px] tracking-[0.25em] text-cyan-100/90 uppercase">
                  {connecting ? (
                    <span className="jarvis-shimmer">Initializing…</span>
                  ) : "Activate Jarvis"}
                </span>
        ...
        <AnimatePresence mode="wait">
          ...
          >
            <span
              ...
              style={{ background: "var(--jarvis-state-color)", boxShadow: "0 0 8px var(--jarvis-state-color)" }}
            />
